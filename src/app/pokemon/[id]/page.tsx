    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        <div className="bg-white p-8 rounded-lg shadow-lg text-center max-w-md">
          <p className="text-red-500 text-xl mb-4">{error || "Pokémon not found"}</p>
          <Link href="/">
            ...
            <div className="grid gap-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-lg shadow-lg p-6 h-full">
                  <h2 className="text-2xl font-semibold mb-4 text-gray-800 border-b pb-2">Abilities</h2>
                  <ul className="space-y-2">
                    {pokemon.abilities.map((ability, index) => (
                      <li key={index} className="capitalize font-medium text-gray-700 flex items-center">
                ...
                {/* Stats section */}
                <div className="bg-white rounded-lg shadow-lg p-6 h-full">
                  <h2 className="text-2xl font-semibold mb-4 text-gray-800 border-b pb-2">Stats</h2>
              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                <h2 className="text-2xl font-semibold mb-4 text-gray-800 border-b pb-2">Moves</h2>
